  ...
  return (
    <>
      ...
      <Carousel className="" fade>
        <Carousel.Item>
          <div class="w-full p-4 text-gray-800 bg-indigo-600 shadow-md">
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <h5 class="font-bold text-indigo-100">Johny Deep</h5>
          ...
          <div class="w-full p-4 text-gray-800 bg-indigo-600 shadow-md">
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <h5 class="font-bold text-indigo-100">Robert Stark</h5>
          ...
          <div class="w-full p-4 text-gray-800 bg-indigo-600 shadow-md">
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <h5 class="font-bold text-indigo-100">Elon Musk</h5>
          ...
          <div class="w-full p-4 text-gray-800 bg-indigo-600 shadow-md">
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <h5 class="font-bold text-indigo-100">Carl Kent</h5>
                <p class="flex items-center text-sm text-gray-100">
                  <FaStar className="text-base text-yellow-500 pr-1" />
                  <span>4.9/5</span>
                </p>
          ...
          <div class="w-full p-4 text-gray-800 bg-indigo-600 shadow-md">
            <div class="mb-2">
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <h5 class="font-bold text-indigo-100">Bruce Wayn</h5>
                <p class="flex items-center text-sm text-gray-100">
                  <FaStar className="text-base text-yellow-500 pr-1" />
                  <span>5/5</span>
                </p>
